...
public class AuctionSuccessObject {
    private int id;
    ...
    private int phone;
    public AuctionSuccessObject() {
    }

    public AuctionSuccessObject(int id, String carFrom, String carTo, String carType, String carHireType, String carWhoHire, String fromDate, String fromTo, String dateBook, int bookPrice, int bookPriceMax, int currentPrice, String timeToReduce, LatLng localtionFrom, LatLng localtionTo, double distance, int phone) {
        this.id = id;
