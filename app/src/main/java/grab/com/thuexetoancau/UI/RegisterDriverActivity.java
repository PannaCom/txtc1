...
public class RegisterDriverActivity extends AppCompatActivity implements GetAllRegisterCarData.onDataReceived {
    ...
    private AutoCompleteTextView txtCarModel;
    ...
    private void initComponents() {
        ...
        txtCarModel = (AutoCompleteTextView)    findViewById(R.id.edt_car_model);
        ...
        txtCarModel.addTextChangedListener(new TextWatcher() {
            @Override
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (txtCarMade.getText().toString().equals("")&& count >0)
                    showDialogCarMade();
            }
        ...
        BaseService.getHttpClient().post(Defines.URL_GET_CAR_MODEL,params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    txtCarModel.setAdapter(adapterProvinceFrom);
                    txtCarModel.setThreshold(1);
