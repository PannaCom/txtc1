...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utilities.systemUiVisibility(this);
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    if (preference.getRole() == 1){
                        Intent i = new Intent(SplashActivity.this, ListDriverAuctionActivity.class);
                        startActivity(i);
                        finish();
                        ...
                        finish();
                            ...
                            Intent i = new Intent(SplashActivity.this, SelectRoleActivity.class);
                            startActivity(i);
                            finish();
                        }
                }
