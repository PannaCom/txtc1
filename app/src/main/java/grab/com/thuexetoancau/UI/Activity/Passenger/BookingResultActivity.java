...
public class BookingResultActivity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        txtPrice.setText(Utilities.convertCurrency(Integer.valueOf(arrResult[0]))+" VNĐ");

        String sNote = "";
        if (Integer.valueOf(arrResult[2]) >0)
            sNote+="- Giá dựa trên cơ bản là "+Utilities.convertCurrency(Integer.valueOf(arrResult[2]))+" đồng/km"+"\n";


        if (Integer.valueOf(arrResult[3]) >0)
            sNote+="- Số tiền tính thêm khi đi quá 1 ngày là "+Utilities.convertCurrency(Integer.valueOf(arrResult[3]))+" đồng"+"\n";
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BookingResultActivity.this, FormPassengerBookingActivity.class);
